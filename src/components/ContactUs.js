      ...
      <section className="text-gray-900 body-font">
        <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
          <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
            <div className="bg-secondary relative flex flex-wrap py-6 rounded shadow-md">
              <div className="lg:w-1/2 px-6">
                ...
                <p className="mt-1">Building No. 5, Raheja Green, Green Acres, Borivali(E), Mumbai 400066, Maharashtra, India</p>
              </div>
              <div className="lg:w-1/2 px-6 mt-6 lg:mt-0">
                <h4 style={{
                  color: 'darkblue'
                }}>EMAIL</h4>
                <p className="mt-1">archana130899@gmail.com  pranavpatel361@gmail.com</p>
                <h4 style={{
                  color: 'darkblue'
                }}>PHONE</h4>
                <p className="leading-relaxed">+91- 9825674931</p>
              </div>
            </div><br />
          ...
          <div className="lg:w-2/6 md:w-1/2 bg-gray-500 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
            <h2 className="text-gray-900 text-lg font-medium title-font mb-5">Connect With Us</h2>
            <div className="relative mb-4">
              <label for="full-name" className="leading-7 text-sm text-gray-1000">Full Name</label>
              <input type="char"onChange={handleChange}  id="CustomerName" name="CustomerName" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" size="lg" />
            </div>
            <div className="relative mb-4">
              <label for="full-name" className="leading-7 text-sm text-gray-1000">Phone Number</label>
              <input type="phone" onChange={handleChange} id="CustomerPhoneNo" name="CustomerPhoneNo" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" size="lg" />
            </div>
            <div className="relative mb-4">
              <label for="email" className="leading-7 text-sm text-gray-1000">Email</label>
              <input type="email" onChange={handleChange} id="CustomerEmail" name="CustomerEmail" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
            </div>
            <div className="relative mb-4">
              <label for="full-name" className="leading-7 text-sm text-gray-1000">Company Name(if not have, type="NA")</label>
            ...
            <button onClick={handleSubmit} className="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Button</button>
            <p className="text-xs text-gray-1000 mt-3">Literally you probably haven't heard of them jean shorts.</p>
          </div>
        </div>
      </section>
